...
// ConfigV1Client is used to interact with features provided by the config.waffle.io group.
type ConfigV1Client struct {
	restClient rest.Interface
}

func (c *ConfigV1Client) RouteRules(namespace string) RouteRuleInterface {
