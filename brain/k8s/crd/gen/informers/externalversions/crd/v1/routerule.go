	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options meta_v1.ListOptions) (runtime.Object, error) {
				...
				return client.ConfigV1().RouteRules(namespace).List(options)
			},
			WatchFunc: func(options meta_v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ConfigV1().RouteRules(namespace).Watch(options)
			},
		},
		&crd_v1.RouteRule{},
		resyncPeriod,
...
func (f *routeRuleInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&crd_v1.RouteRule{}, f.defaultInformer)
}

func (f *routeRuleInformer) Lister() v1.RouteRuleLister {
	return v1.NewRouteRuleLister(f.Informer().GetIndexer())
}
