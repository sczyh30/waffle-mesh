...
type RouteRuleLister interface {
	...
	List(selector labels.Selector) (ret []*v1.RouteRule, err error)
...
// List lists all RouteRules in the indexer.
func (s *routeRuleLister) List(selector labels.Selector) (ret []*v1.RouteRule, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1.RouteRule))
	})
	return ret, err
}
...
type RouteRuleNamespaceLister interface {
	...
	Get(name string) (*v1.RouteRule, error)
...
// List lists all RouteRules in the indexer for a given namespace.
func (s routeRuleNamespaceLister) List(selector labels.Selector) (ret []*v1.RouteRule, err error) {
...
// Get retrieves the RouteRule from the indexer for a given namespace and name.
func (s routeRuleNamespaceLister) Get(name string) (*v1.RouteRule, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1.Resource("routerule"), name)
	}
	return obj.(*v1.RouteRule), nil
}
